...
export const websiteSchema = {
    ...
    "@type": "WebSite",
    "name": "Zavi",
    "alternateName": ["Zavi AI", "Zavi Voice Agent", "Zavi Voice to Action", "Zavi App", "Zavi Voice"],
...
export const softwareApplicationSchema = {
    ...
    "description": "Voice to Action OS with autonomous background agents, 27+ app integrations, and WhatsApp/Telegram bot reporting. Speak to type perfect text, execute commands across Gmail/Slack/GitHub/Notion, or create scheduled automations — all from your keyboard. Available on Android, iOS, macOS, Windows, and Linux.",
    "url": "https://zavivoice.com",
...
export const faqSchema = {
    ...
    "mainEntity": [
        ...
        },
        {
            ...
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Zavi is approximately 4x faster than typing. The average person types at 40 words per minute but speaks at 150 words per minute. Since Zavi eliminates the editing phase entirely (AI handles filler removal and grammar), a 500-word email that takes 12 minutes to type can be dictated in about 3 minutes."
            }
        },
        {
            "@type": "Question",
...
// ============================================
export function generateDefinedTermSetSchema(terms: { term: string; slug: string; shortDefinition: string }[]) {
    return {
        "@context": "https://schema.org",
        "@type": "DefinedTermSet",
        "name": "Zavi AI Voice Typing Glossary",
        "description": "Comprehensive glossary of voice typing, speech-to-text, and AI dictation terminology.",
