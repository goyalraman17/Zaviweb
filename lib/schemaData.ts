  ...
  offers: [
    {
      ...
      priceCurrency: 'USD',
      description:
        'AI speech cleanup, works in every app, 100+ languages, daily usage limits',
    },
    {
      '@type': 'Offer',
      ...
      description:
        'Unlimited usage, 3x faster processing, priority support, advanced formatting',
    },
    {
      '@type': 'Offer',
      ...
      description:
        'Unlimited usage, 3x faster processing, priority support, advanced formatting — 2 months free',
    },
  ],
  featureList: [
    ...
    'System-wide keyboard works in every app on all 5 platforms',
...
export const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Zavi is approximately 4x faster than typing. The average person types at 40 words per minute but speaks at 150 words per minute. Since Zavi removes filler words and handles cleanup for you, a long email or message can often be drafted in a fraction of the usual typing time.',
      },
    },
    {
      '@type': 'Question',
...
export const howToSchema = {
  ...
  description:
    'Learn how to use Zavi AI to type 4x faster by speaking naturally. Zavi turns your voice into clean, professional text in any app.',
  totalTime: 'PT2M',
  step: [
    {
      '@type': 'HowToStep',
...
export const founderSchemas = [
  {
    ...
    sameAs: 'https://www.linkedin.com/in/ramangoyal3',
    description:
      'Founder and CEO of Zavi AI. Previously built voice AI systems. Founded Zavi to eliminate the gap between human thought and written communication.',
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Person',
    ...
    sameAs: 'https://www.linkedin.com/in/hsyvy/',
    description:
      "Co-founder and CTO of Zavi AI. Deep expertise in ML systems and infrastructure. Builds the technology behind Zavi's AI-powered voice-to-text transformation.",
  },
];
...
export const videoObjectSchema = {
  ...
  description:
    'Watch how Zavi AI transforms natural speech into clean, professional text. See filler word removal, grammar correction, and real-time processing in action.',
  ...
  potentialAction: {
    '@type': 'SeekToAction',
    target:
      'https://www.youtube.com/watch?v=rkBgOnhopyg&t={seek_to_second_number}',
...
export const speakableSchema = {
  ...
  speakable: {
    ...
    cssSelector: ['h1', "[itemProp='description']", '.sr-only'],
  },
  mainEntity: {
    '@type': 'SoftwareApplication',
    name: 'Zavi AI',
...
// ============================================
// ItemList Schema Generator — For landing page rich results
// ============================================
...
// ============================================
// DefinedTermSet Schema — For glossary landing page
// ============================================
export function generateDefinedTermSetSchema(
  terms: { term: string; slug: string; shortDefinition: string }[]
) {
  return {
    '@context': 'https://schema.org',
    '@type': 'DefinedTermSet',
    ...
    description:
      'Comprehensive glossary of voice typing, speech-to-text, and AI dictation terminology.',
    url: 'https://zavivoice.com/glossary',
    hasDefinedTerm: terms.map((t) => ({
      '@type': 'DefinedTerm',
      name: t.term,
      description: t.shortDefinition,
      url: `https://zavivoice.com/glossary/${t.slug}`,
    })),
  };
}
