...
export const glossaryTerms: GlossaryTerm[] = [
  {
    ...
    term: 'Voice Typing',
    shortDefinition:
      'Using speech recognition to convert spoken words into typed text on a device.',
    fullDefinition:
      "Voice typing (also called voice-to-text, dictation, or speech typing) is the process of speaking into a device's microphone and having your speech converted to written text in real-time. Modern AI voice typing tools like Zavi AI go beyond basic transcription, they use AI to clean up filler words, fix grammar, add punctuation, and restructure sentences into professional-quality written text. Voice typing is typically 3-4x faster than thumb typing on mobile devices.",
  ...
  },
  {
    ...
    term: 'Dictation',
    shortDefinition:
      'The practice of speaking text aloud for it to be transcribed, either by a person or by software.',
    fullDefinition:
  ...
  },
  {
    ...
    fullDefinition:
      'Voice recognition (or speech recognition) is the technology that enables machines to receive, interpret, and process human voice input. There are two main types: speaker recognition (identifying who is speaking) and speech recognition (understanding what is being said). In voice typing applications, speech recognition converts spoken words into text. Modern voice recognition systems use deep learning neural networks trained on millions of hours of speech data, achieving accuracy rates above 95% in optimal conditions.',
  ...
  },
  {
    ...
    term: 'AI Cleanup',
    shortDefinition:
      'The process of using artificial intelligence to automatically correct, format, and polish text from speech.',
    fullDefinition:
      'AI Cleanup refers to the post-processing step in advanced voice typing where artificial intelligence analyzes raw transcribed text and improves it for written communication. This includes removing filler words ("um," "uh"), correcting grammar and punctuation, restructuring spoken-style sentences into written-style sentences, adding proper capitalization, and formatting text appropriately. AI Cleanup is what distinguishes modern AI voice typing tools like Zavi AI from basic transcription services like Google Voice Typing, the output is ready to send without manual editing.',
    relatedTerms: [
      'Filler Word Removal',
      'Grammar Correction',
      'Post-Processing',
  ...
  },
  {
    ...
    term: 'Magic Wand',
    shortDefinition:
      'A voice-driven editing feature that lets you transform any selected text by describing the change aloud.',
    fullDefinition:
      'Magic Wand is Zavi AI\'s in-place voice editing feature. Select any text in any app, activate the Magic Wand, and describe the change you want, "make this more professional," "shorten this," "translate to Japanese," or "rewrite as bullet points." The AI rewrites the text in-place instantly, without copy-pasting or switching apps. Magic Wand works in two modes: Edit Mode (transforms existing highlighted text) and Command Mode (generates new text from a voice instruction). It is available on all platforms, Android, iOS, macOS, Windows, and Linux.',
    relatedTerms: ['Voice Editing', 'In-Place Editing', 'Text Transformation'],
    seeAlso: ['voice-agent', 'voice-typing', 'ai-cleanup'],
  },
  {
    slug: 'voice-agent',
    term: 'Voice Agent',
    shortDefinition:
      'An AI system that executes cross-app actions from natural voice commands, not just transcription, but task completion.',
    fullDefinition:
      'A Voice Agent goes beyond voice typing by actually executing tasks across applications. Instead of just converting speech to text, a Voice Agent understands your intent and performs actions: "Send David an email about Thursday\'s meeting" triggers the agent to compose and send the email via Gmail. "Post to Slack that the deploy is done" posts the message directly. Zavi AI\'s Voice Agent connects to 27+ services including Gmail, Slack, GitHub, Notion, LinkedIn, Google Calendar, and more. It uses a multi-turn tool-calling loop, classifying your intent, selecting the right integration, and executing the action. Voice Agents represent the evolution from voice-to-text to voice-to-action.',
    relatedTerms: ['Voice Assistant', 'Voice Commands', 'Task Automation'],
    seeAlso: ['voice-typing', 'magic-wand', 'zero-prompting'],
  },
  {
    slug: 'voice-ai-keyboard',
    term: 'Voice AI Keyboard',
    shortDefinition:
      'A smartphone keyboard app that uses AI to enable intelligent voice typing across all applications.',
    fullDefinition:
      'A Voice AI Keyboard is a keyboard application (primarily for smartphones) that integrates AI-powered voice typing as a core input method. Unlike standalone dictation apps, a Voice AI Keyboard works system-wide across all apps, WhatsApp, Gmail, Slack, Instagram, ChatGPT, and any other app with a text field. Zavi AI is a leading example of a Voice AI Keyboard, offering AI cleanup, filler word removal, grammar correction, and real-time translation built directly into the keyboard interface.',
