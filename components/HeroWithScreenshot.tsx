          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] sm:text-xs font-bold text-zavi-blue-600 uppercase tracking-tighter">Zavi fixes and writes</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-tighter">Ready</span>
              </div>
            </motion.div>
