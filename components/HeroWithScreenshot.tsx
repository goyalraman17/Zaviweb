                  ...
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-[13px] sm:text-[15px] text-slate-700 font-medium leading-relaxed">
                          {item.cmd}
                        </p>
                        <span className="inline-block mt-1 text-[11px] font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">
                          {item.tag}
                        </span>
                      </div>
                    </div>
