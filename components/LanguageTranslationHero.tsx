...
const LANGUAGE_FLOWS = [
  {
    input: {
      ...
      name: 'Hindi',
      example:
        'हाँ तो... आज मीटिंग में, उम्म, quarterly targets के बारे में बात की और marketing budget को 15% बढ़ाने का decide किया था।',
    },
    output: {
      flag: '🇬🇧',
      name: 'English',
      text: "In today's meeting, we discussed the quarterly targets and agreed to increase our marketing budget by 15%.",
    },
  },
  {
    input: {
      ...
      name: 'Spanish',
      example:
        'Bueno, necesitamos como... hablar del timeline del proyecto, no? Y asegurar que todo el mundo está, eh, alineado con los deliverables.',
    },
    output: {
      flag: '🇬🇧',
      name: 'English',
      text: 'We need to discuss the project timeline and ensure all stakeholders are aligned on the deliverables.',
    },
  },
  {
    input: {
      ...
      name: 'Japanese',
      example:
        'えーと、来週の月曜日に、あの、クライアントミーティングがあって、プレゼンの準備をしなきゃいけないんですけど...',
    },
    output: {
      flag: '🇬🇧',
      name: 'English',
      text: 'We have a client meeting next Monday and need to prepare the presentation materials beforehand.',
    },
  },
  {
    input: {
      ...
      name: 'English',
      example:
        'So um, just wanted to let you know that the proposal got approved and we can like, move forward with next phase now.',
    },
    output: {
      flag: '🇫🇷',
      name: 'French',
      text: 'Je voudrais vous informer que la proposition a été approuvée et nous pouvons procéder à la prochaine étape.',
    },
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-500 max-w-2xl mx-auto font-medium">
              Speak Hindi, get perfect English. Speak English, get professional
              French. Zavi translates, removes filler words, and fixes grammar,
              all in real-time.
            </p>
          </motion.div>
