...
const testimonials = [
  ...
  {
    quote:
      'Privacy-first design. Mic only activates when I press it. No recordings stored. The only voice tool my security team approved.',
    author: 'Priya Patel',
  ...
  {
    quote:
      "I dictate in Spanish and it types perfect English emails. The Magic Wand lets me highlight any text and say 'make this formal.' It just works.",
    author: 'Elena Rossi',
...
export default function Testimonials() {
  ...
  return (
    <section
      ref={ref}
      className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-blue-50/50 via-white to-sky-50/50"
    >
      ...
      <div className="container mx-auto px-6">
        ...
        <div
          className="relative overflow-hidden w-full max-w-[100vw] py-8"
          ...
          <div className="flex">
            ...
            >
              ...
              {[...testimonials, ...testimonials].map((testimonial, index) => (
                <div
                  key={index}
                  className="w-[300px] sm:w-[350px] md:w-[450px] flex-shrink-0"
                >
                  <div
                    itemScope
                    itemProp="review"
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        className="text-base text-gray-700 leading-relaxed mb-6 relative z-10"
                        itemProp="reviewBody"
                      >
                        "{testimonial.quote}"
                      </p>
