    ...
    <section ref={ref} className="py-24 md:py-32 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          {/* Dynamic SVG Data Flow Visualization */}
          <motion.div className="relative w-full max-w-5xl mx-auto h-[500px] mb-20 flex items-center justify-center" variants={fadeUp}>
            ...
            {/* SVG Connecting Lines & Flowing Particles */}
            <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
              ...
              {/* Paths to the 6 outer nodes */}
              <path id="path-slack" d="M 50% 50% L 15% 20%" stroke="url(#lineGrad)" strokeWidth="2" strokeDasharray="6,6" />
              <path id="path-whatsapp" d="M 50% 50% L 50% 10%" stroke="url(#lineGrad)" strokeWidth="2" strokeDasharray="6,6" />
              <path id="path-notion" d="M 50% 50% L 85% 20%" stroke="url(#lineGrad)" strokeWidth="2" strokeDasharray="6,6" />
              <path id="path-gmail" d="M 50% 50% L 15% 80%" stroke="url(#lineGrad)" strokeWidth="2" strokeDasharray="6,6" />
              <path id="path-docs" d="M 50% 50% L 50% 90%" stroke="url(#lineGrad)" strokeWidth="2" strokeDasharray="6,6" />
            ...
            {/* Orbiting App Nodes - Static Absolute Positioning Map */}

            {/* Top Left - Slack */}
            <motion.div
              className="absolute top-[10%] left-[5%] md:left-[10%] w-16 h-16 md:w-20 md:h-20 bg-white/80 backdrop-blur-sm shadow-xl border border-gray-100 rounded-2xl flex items-center justify-center z-10"
              animate={{ y: [-8, 8, -8] }} transition={{ duration: 4, repeat: Infinity, delay: 0 }}
            >
            ...
            {/* Top Center - WhatsApp */}
            <motion.div
              className="absolute top-[0%] w-16 h-16 md:w-20 md:h-20 bg-white/80 backdrop-blur-sm shadow-xl border border-gray-100 rounded-2xl flex items-center justify-center z-10"
              animate={{ y: [-6, 6, -6] }} transition={{ duration: 4.5, repeat: Infinity, delay: 1 }}
            >
            ...
            {/* Top Right - Notion */}
            <motion.div
              className="absolute top-[10%] right-[5%] md:right-[10%] w-16 h-16 md:w-20 md:h-20 bg-white/80 backdrop-blur-sm shadow-xl border border-gray-100 rounded-2xl flex items-center justify-center z-10"
              animate={{ y: [-5, 5, -5] }} transition={{ duration: 4.2, repeat: Infinity, delay: 0.5 }}
            >
              <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 24 24" fill="#000">
                <path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm.793 3.08v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.841-.046.935-.56.935-1.167V6.354c0-.606-.233-.887-.748-.84l-15.177.887c-.56.047-.747.327-.747.887zm14.337.745c.093.42 0 .84-.42.888l-.7.14v10.264c-.608.327-1.168.514-1.635.514-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952L12.21 19s0 .84-1.168.84l-3.222.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-1.026.793-1.073l3.456-.233 4.764 7.279v-6.44l-1.215-.139c-.093-.514.28-.887.747-.933zM1.936 1.035l13.31-.98c1.634-.14 2.055-.047 3.082.7l4.249 2.986c.7.513.934.653.934 1.213v16.378c0 1.026-.373 1.634-1.68 1.726l-15.458.934c-.98.047-1.448-.093-1.962-.747l-3.129-4.06c-.56-.747-.793-1.306-.793-1.96V2.667c0-.839.374-1.54 1.447-1.632z" />
              </svg>
            </motion.div>
            ...
            {/* Bottom Left - Gmail */}
            <motion.div
              className="absolute bottom-[10%] left-[5%] md:left-[10%] w-16 h-16 md:w-20 md:h-20 bg-white/80 backdrop-blur-sm shadow-xl border border-gray-100 rounded-2xl flex items-center justify-center z-10"
              animate={{ y: [-7, 7, -7] }} transition={{ duration: 4.8, repeat: Infinity, delay: 0.2 }}
            >
              <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 24 24">
                <path fill="#EA4335" d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z" />
                <path fill="#FBBC04" d="M0 5.457C0 3.434 2.309 2.28 3.927 3.493L12 9.548V16.64L0 8.91z" />
            ...
            {/* Bottom Center - Docs */}
            <motion.div
              className="absolute bottom-[0%] w-16 h-16 md:w-20 md:h-20 bg-white/80 backdrop-blur-sm shadow-xl border border-gray-100 rounded-2xl flex items-center justify-center z-10"
              animate={{ y: [-9, 9, -9] }} transition={{ duration: 4.1, repeat: Infinity, delay: 0.8 }}
            >
              <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 24 24">
                <path fill="#4285F4" d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6z" />
                <path fill="#A1C2FA" d="M14 2v6h6L14 2z" />
            ...
            <motion.div
              className="absolute bottom-[10%] right-[5%] md:right-[10%] w-16 h-16 md:w-20 md:h-20 bg-white/80 backdrop-blur-sm shadow-xl border border-gray-100 rounded-2xl flex items-center justify-center z-10"
              animate={{ y: [-6, 6, -6] }} transition={{ duration: 3.9, repeat: Infinity, delay: 1.2 }}
            >
              <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 24 24" fill="#0A66C2">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </motion.div>
          </motion.div>
