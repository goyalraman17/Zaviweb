...
export default function FinalCTA() {
    return (
        <section className="py-24 relative overflow-hidden bg-white">
            {/* Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-gray-50/50 blur-[120px] rounded-full pointer-events-none" />
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    >
                        Your voice.{' '}
                        <span className="text-gray-900 underline decoration-gray-200 underline-offset-8">Every app.</span>
                    </motion.h2>
                    ...
                    <motion.div variants={fadeUp} className="flex flex-col items-center gap-4">
                        <a
                            href="/#download"
                            className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold text-white bg-gray-900 rounded-xl overflow-hidden transition-all hover:bg-gray-800 shadow-sm"
                        >
