            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="flex flex-col items-center gap-4">
                        <a
                            href="/#download"
                            className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-zavi-blue-600 to-indigo-600 rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(37,99,235,0.4)]"
                        >
