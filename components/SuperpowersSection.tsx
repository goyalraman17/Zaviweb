            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-6 tracking-tight text-balance">
                        27+ apps. <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">One voice.</span>
                    </motion.h2>
                    <motion.p variants={fadeUp} className="text-xl text-gray-600 max-w-2xl mx-auto font-medium">
                        Zavi connects to your entire stack. Send emails, post to Slack, create Notion tasks, and search the web — all without touching an app.
                    </motion.p>
                </motion.div>
                ...
                >
                    <Link href="/integrations" className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 rounded-xl text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm mr-4">
