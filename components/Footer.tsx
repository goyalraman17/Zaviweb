  ...
  return (
    <footer className="relative bg-[#FAFAFA] pt-24 pb-32 md:pb-12 overflow-hidden border-t border-slate-200">
      <div className="container-large relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <h3 className="text-lg font-bold text-slate-800 mb-2">Stay in the loop</h3>
          <p className="text-sm text-slate-500 mb-4">Product updates, new integrations, and tips. No spam.</p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
