      ...
      <div className="container-large relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-left mb-32">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-serif text-slate-800 font-medium mb-6">
              Company
            </h3>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-20 max-w-md mx-auto text-center"
        >
          ...
          <form
            onSubmit={(e) => {
              ...
              if (email) {
                // Analytics tracking
                (window as any).gtag?.('event', 'newsletter_signup', { email });
                form.reset();
          ...
          >
            <input
              ...
              required
              className="flex-1 px-4 py-3 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-slate-800 placeholder:text-slate-400"
            />
            <button
              type="submit"
              className="px-5 py-3 text-sm font-bold text-white bg-[#0a0a0a] rounded-xl hover:bg-[#1a1a1a] transition-colors flex-shrink-0"
            >
              Subscribe
            </button>
          </form>
        ...
        >
          <div className="flex items-center gap-8 px-4 w-full justify-center hover:opacity-80 transition-opacity">
            <Link href="/">
              <span className="block text-[100px] md:text-[200px] leading-none font-black text-slate-900 tracking-tighter cursor-pointer">
                Zavi
              </span>
            </Link>
          </div>
