        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
              Available on all your devices. Free to start.
            </motion.p>
          </div>
          ...
          >
            {PLATFORMS.map((platform) => (
              <motion.div
                key={platform.name}
                className="group bg-white rounded-2xl border border-zavi-border/50 p-8 hover:shadow-xl hover:border-zavi-blue/30 transition-all duration-300"
                variants={fadeUp}
              >
                <div className="text-zavi-charcoal group-hover:text-zavi-blue transition-colors mb-4">
                  {platform.icon}
                </div>
                <h3 className="text-2xl font-bold text-zavi-charcoal mb-2">
                  {platform.name}
                </h3>
                ...
                {platform.comingSoon ? (
                  <div className="px-6 py-3 bg-zavi-paper rounded-xl text-center">
                    <span className="text-sm font-semibold text-zavi-gray-text">
                      Coming Soon
                    </span>
                  </div>
                ) : (
                  <motion.button
                    className="w-full px-6 py-3 bg-zavi-blue hover:bg-zavi-blue-500 text-white font-semibold rounded-xl transition-all shadow-md hover:shadow-lg"
                    initial="rest"
                    whileHover="hover"
                    whileTap="tap"
                    variants={ctaPrimary}
          ...
          >
            <motion.div
              className="p-6 bg-white rounded-xl border border-zavi-border/50"
              variants={fadeUp}
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-bold text-zavi-charcoal">Free to Start</h4>
              </div>
              <p className="text-sm text-zavi-gray-text">
                100 conversions/month on the free plan. No credit card required.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-bold text-zavi-charcoal">System-Level</h4>
              </div>
              <p className="text-sm text-zavi-gray-text">
                Integrates directly into your keyboard. Works everywhere.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-bold text-zavi-charcoal">Instant Setup</h4>
              </div>
              <p className="text-sm text-zavi-gray-text">
                Up and running in 30 seconds. No configuration needed.
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
