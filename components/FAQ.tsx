...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Zavi has WhatsApp and Telegram bots that act as your AI assistant's communication channel. Background agents deliver summaries, ask for approvals ('Should I send this email?'), and let you respond with simple replies like 'Yes' or 'Edit the subject line.' It's like having a chief of staff in your pocket.",
  },
  {
    question: 'What apps does Zavi integrate with?',
    answer:
      'Zavi connects to 27+ apps including Gmail, Slack, GitHub, Notion, Calendar, LinkedIn, WhatsApp, Telegram, iMessage, web search, and more. You can execute commands across any connected app by voice, and background agents can monitor and act on them automatically.',
  },
];
