...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-zavi-blue-50 via-white to-zavi-paper">
      {/* Subtle grid pattern */}
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <div className="relative w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-2xl border-2 border-zavi-border">
          ...
          >
            Type 5x Faster
            <br />
            <span className="bg-gradient-to-r from-zavi-blue to-zavi-blue-600 bg-clip-text text-transparent">
              Just by Speaking
            </span>
          </motion.h1>
          ...
          >
            <motion.a
              ...
              className="group relative px-8 sm:px-10 py-4 sm:py-5 text-lg font-semibold text-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
      ...
      >
        <motion.div
          ...
          className="flex flex-col items-center gap-2 text-zavi-gray-text"
        >
