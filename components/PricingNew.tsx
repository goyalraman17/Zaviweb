...
export default function PricingNew() {
  ...
  const handleEmailSubmit = () => {
    ...
    console.log('[Pricing] Email submitted', {
      pendingPlan,
      billingCycle,
      email: trimmed,
    });
  ...
  const handlePayment = async (plan: string, email: string) => {
    ...
    setPaymentStep('Creating your subscription...');
    console.log('[Pricing] handlePayment called', {
      plan,
      billingCycle,
      email,
    });
        ...
        handler: async function (response: any) {
          ...
          try {
            ...
            if (verifyRes.ok && result.success) {
              ...
              setResultMessage(
                'Your Pro subscription is now active! Open the Zavi app to enjoy unlimited access.'
              );
              setResultPaymentId(
              ...
              setResultType('error');
              setResultMessage(
                result.error || 'Payment received but activation failed.'
              );
              setResultPaymentId(
                response.razorpay_subscription_id ||
                  response.razorpay_payment_id
          ...
          >
              ...
              <div className="inline-flex items-center gap-1 p-1 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200 shadow-md">
                <button
                  onClick={() => {
                    ...
                    analytics.track('pricing_toggle_billing', {
                      cycle: 'monthly',
                    });
                  }}
                  ...
                  <ul className="space-y-4 mb-8 flex-grow">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Daily word limit, type anywhere by voice
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Edit, rewrite, or transform any text by voice
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Fastest transcription with AI enhancement
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Casual, formal, or fun. Your voice, your style.
                        </span>
                      </div>
                    </li>
                  </ul>
                ...
                <GlowCard glowColor="rgba(0, 0, 0, 0.05)" className="h-full">
                  <div className="relative rounded-3xl p-8 bg-white border-2 border-gray-900 shadow-xl transform md:scale-105 h-full">
                    ...
                    <ul className="space-y-4 mb-8">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <span className="block text-sm text-gray-600">
                            No daily word limits, type anywhere by voice
                          </span>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                    ...
                    <motion.button
                      ...
                      variants={ctaPrimary}
                    >
                      {getButtonText().includes('Try')
                        ? 'Get Pro Access'
                        : getButtonText()
                            .replace('Get Zavi for', 'Start Pro on')
                            .replace('Download for', 'Start Pro on')}
                    </motion.button>
                  </div>
                </GlowCard>
              </motion.div>
                  ...
                  <ul className="space-y-4 mb-8 flex-grow">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          No daily word limits for any team member
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Stay consistent across all team messages
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Track and measure team time savings
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Simple user management and unified billing
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-600">
                          Get dedicated help when your team needs it
                        </span>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="text-center mb-16">
              <p className="text-gray-500 text-sm">
                * Subject to fair usage policy. See{' '}
          ...
          >
            ...
            <div className="p-8">
              ...
              <p className="text-center text-gray-500 text-sm mb-6">
                Use the same email as your Zavi account so we can activate Pro
                on your device.
              </p>
              ...
              <div className="mb-4">
                <input
                  ...
                  className={`w-full px-4 py-3.5 rounded-xl border-2 text-gray-900 placeholder-gray-400 outline-none transition-all text-base ${
                    emailError
            ...
            <div className="p-8">
              ...
              <div
                className={`w-16 h-16 mx-auto mb-5 rounded-full flex items-center justify-center ${
                  resultType === 'success' ? 'bg-green-100' : 'bg-orange-100'
                }`}
              >
                {resultType === 'success' ? (
                  <svg
              ...
              <h3
                className={`text-2xl font-bold text-center mb-2 ${
                  resultType === 'success' ? 'text-gray-900' : 'text-gray-900'
                }`}
              >
                {resultType === 'success'
                  ? '🎉 Payment Successful!'
              ...
              <button
                onClick={() => setShowResultModal(false)}
                className={`w-full px-5 py-3.5 rounded-xl font-semibold text-white transition-all ${
                  resultType === 'success'
