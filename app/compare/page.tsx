...
import CoreFeaturesMatrix from '@/components/CoreFeaturesMatrix';
...
export default function ComparePage() {
  ...
  const itemListSchema = generateItemListSchema(
    comparisons.map((c) => ({
      name: `Zavi AI vs ${c.competitorName}`,
      url: `https://zavivoice.com/compare/${c.slug}`,
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-20">
            ...
            <div className="max-w-3xl">
              <p className="text-xl text-gray-600 mb-4">
                Every generational tech company owned an interface. Microsoft
                owned keyboard and mouse. Apple owned touch. Google owned
                search.
              </p>
              <p className="text-xl text-gray-600 mb-4">
                The next interface is not chat. The next interface is{' '}
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <p className="text-sm text-gray-600">
                  Turn speech into text. But text is not action. You still have
                  to edit, format, and send manually.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <p className="text-sm text-gray-600">
                  Powerful intelligence locked in a chat window. Requires
                  prompting, context-switching, and copy-paste.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="text-2xl mb-3">👁️</div>
                ...
                <p className="text-sm text-gray-600">
                  Can see your screen and discuss it. But they can&apos;t type,
                  reply, or execute actions inside apps.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="text-2xl mb-3">⚙️</div>
                ...
                <p className="text-sm text-gray-600">
                  Pre-defined triggers for known workflows. Can&apos;t handle
                  ad-hoc decisions or voice-triggered actions.
                </p>
              </div>
            </div>
            <p className="text-center text-gray-500 mt-8 text-lg">
              Zavi is the only platform that combines{' '}
              <strong className="text-gray-900">
                voice input + zero prompting + screen awareness + in-app
                execution
              </strong>
              .
            </p>
          ...
          <div className="mb-20">
            ...
            <p className="text-gray-600 mb-8">
              Seven capabilities. Five categories. Only one platform checks
              every box.
            </p>
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    {masterComparison.map((row, i) => (
                      ...
                      >
                        <td className="py-4 px-3 font-medium text-gray-900 text-sm">
                          {row.capability}
                        </td>
                        {masterComparisonColumns.map((col) => {
                          ...
                          return (
                            <td
                              key={col.key}
                              className={`py-4 px-3 text-center text-sm ${isZavi ? 'bg-blue-50/60' : ''} ${
                                isCheck
                                  ? isZavi
          ...
          <div className="bg-gray-900 rounded-2xl p-8 sm:p-12 text-center">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              AI that talks is impressive. AI that executes across all software
              and languages is inevitable. Try Zavi free today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/demo"
                className="inline-block px-8 py-4 border border-gray-600 text-gray-300 font-semibold rounded-xl hover:bg-gray-800 transition-colors text-lg"
              >
                Watch Live Demo →
              </Link>
            </div>
