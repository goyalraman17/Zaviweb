...
import { generateBreadcrumbSchema, generateItemListSchema } from '@/lib/schemaData';
...
export const metadata: Metadata = {
    ...
    description: 'Compare Zavi AI to Wispr Flow, ChatGPT, Claude, Gemini Live, Gboard, SwiftKey, Dragon, Zapier, Siri & more. The only tool with voice input, zero prompting, screen awareness, and in-app execution. Free download.',
    ...
    openGraph: {
        ...
        images: [{ url: 'https://zavivoice.com/og-image.png', width: 1200, height: 630, alt: 'Zavi AI vs Every Alternative — Full Comparison 2026' }],
    },
};
