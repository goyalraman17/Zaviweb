...
export default async function UseCasePage({ params }: UseCasePageProps) {
  ...
  const proofItems = [
    ...
    { label: 'Outcome', value: 'Speak naturally and get sendable text faster' },
  ];
  const comparisonRows = [
    {
      label: 'Drafting',
      withoutZavi:
        'Type every sentence by hand, clean up grammar later, and lose momentum while editing.',
      withZavi:
        'Speak once, let Zavi remove filler words, and get polished text directly inside the app you are already using.',
    },
    {
      label: 'Quality',
      withoutZavi:
        'Rough drafts usually keep the hesitation, repetition, and awkward phrasing from first-pass thinking.',
      withZavi: uc.exampleAfter,
    },
    {
      label: 'Follow-through',
      withoutZavi:
        'You still have to switch apps, format the text, and finish the workflow manually.',
      withZavi:
        'Use voice commands and connected actions to keep the task moving without breaking flow.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-14">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/demo"
                className="inline-flex items-center justify-center px-6 py-3 bg-white text-gray-900 font-semibold rounded-xl border border-gray-300 hover:border-gray-400 transition-colors"
              >
                Try Live Demo
              </Link>
            </div>
          ...
          <div className="mb-14 rounded-[2rem] border border-slate-200 bg-slate-50 p-6 sm:p-8">
            <h2 className="text-2xl font-bold text-slate-950">
              What this page helps you decide
            </h2>
            <p className="mt-3 text-base leading-7 text-slate-600">
              This page shows where {uc.title.toLowerCase()} gets slower with
              manual typing, what changes once voice becomes the input layer,
              and why teams adopt Zavi when they want faster output without
              extra cleanup.
            </p>
          </div>
          ...
          <div className="mb-14">
            <SimpleComparisonTable
              title={`${uc.title}: manual workflow vs Zavi`}
              rows={comparisonRows}
              withoutLabel="Manual typing"
              withLabel="With Zavi"
            />
          </div>
          ...
          <div className="bg-blue-600 rounded-2xl p-8 md:p-12 text-center mb-14">
            ...
            <p className="text-blue-100 mb-6">
              Download Zavi AI for free and start today.
            </p>
            <Link
              href="/download"
              className="inline-flex px-8 py-3 bg-white text-blue-600 font-semibold rounded-xl hover:bg-blue-50 transition-colors"
            >
              Download Free
            </Link>
          </div>
                  ...
                  (rc: UseCase) =>
                    rc && (
                      <Link
                        ...
                        className="group block p-5 rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all"
                      >
