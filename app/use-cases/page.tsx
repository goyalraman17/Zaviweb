...
export const metadata: Metadata = {
  ...
  description:
    'Discover how professionals use Zavi AI voice typing for email, WhatsApp, Slack, academic writing, and accessibility. See real before/after examples.',
  alternates: { canonical: 'https://zavivoice.com/use-cases' },
  openGraph: {
    title: 'Zavi AI Use Cases: Voice Typing for Every Professional',
    description:
      'Email, WhatsApp, Slack, essays, accessibility, see how Zavi AI transforms voice into action across every use case.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Zavi AI Use Cases: Voice Typing for Every Professional',
      },
    ],
  },
};
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Zavi AI works in every app. See how professionals save hours every
              week with AI-powered voice typing.
            </p>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-gray-400 mb-6">
              Download Zavi AI and start speaking your way to better
              productivity.
            </p>
            <Link
              href="/download"
              className="inline-flex px-8 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors"
            >
              Download Free
            </Link>
          </div>
