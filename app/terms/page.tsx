...
export const metadata = {
  ...
  description: "Zavi AI's terms of service. Read our terms and conditions for using the Zavi AI application.",
  alternates: { canonical: 'https://zavivoice.com/terms' },
  openGraph: {
    title: 'Terms of Service — Zavi AI',
    description: 'Read the terms and conditions for using Zavi AI.',
