...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Zavi AI Voice Integrations & Superpowers',
        description: 'Control 27+ apps hands-free with Zavi AI. Gmail, Slack, GitHub, Notion, LinkedIn, Calendar, and more.',
        url: 'https://zavivoice.com/integrations',
        images: [{ url: 'https://zavivoice.com/og-image.png', width: 1200, height: 630, alt: 'Zavi AI — Voice Integrations & Superpowers' }],
    },
};
