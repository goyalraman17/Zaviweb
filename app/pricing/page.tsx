...
export const metadata: Metadata = {
    title: 'Pricing — Zavi AI Voice to Action OS | Free & Pro Plans',
    description: 'Zavi AI pricing: Free plan with voice typing, background agents, and 27+ integrations. Pro at $7.99/month for unlimited usage. Works on all 5 platforms.',
...
export default function PricingPage() {
    ...
    const productSchema = {
        ...
        '@type': 'Product',
        name: 'Zavi AI',
        description: 'Voice to Action OS with autonomous background agents, 27+ app integrations, and WhatsApp/Telegram bot reporting. Available on Android, iOS, macOS, Windows, and Linux.',
