...
function getIsoDate(dateLabel: string): string {
  ...
  if (!monthName || !year || !monthMap[monthName]) return dateLabel;
  return `${year}-${monthMap[monthName]}-01`;
}

export const metadata: Metadata = {
  title: 'Blog – Voice AI, Productivity & Future of Work',
  description:
    'Explore insights on AI voice typing, productivity hacks, voice AI technology, and the future of human-computer interaction. Written by the Zavi AI team.',
  alternates: {
    canonical: '/blog',
  },
  openGraph: {
    ...
    description:
      'Explore insights on AI voice typing, productivity hacks, voice AI technology, and the future of work.',
...
export default function BlogListingPage() {
  ...
  const blogListingSchema = {
    ...
    name: 'Zavi AI Blog',
    description:
      'Insights on voice AI, productivity, and the future of work from the Zavi AI team.',
    url: 'https://zavivoice.com/blog',
    publisher: {
      '@type': 'Organization',
      name: 'Zavi AI',
              ...
              <div className="relative">
                <div className="sm:text-center">
                  ...
                  <p className="mt-6 mx-auto max-w-2xl text-lg text-blue-100">
                    Join forward-thinking professionals reclaiming their time
                    with voice AI.
                  </p>
                </div>
                <form
