...
const platformData: Record<string, {
    ...
    ios: {
        ...
        metaTitle: 'Download Zavi AI for iPhone & iPad — Free Voice Typing Keyboard for iOS',
    ...
    android: {
        ...
        metaTitle: 'Download Zavi AI for Android — Free Voice Typing Keyboard App',
        metaDescription: 'Download Zavi AI voice typing keyboard for Android. AI removes filler words, fixes grammar, works in every app. Free on Google Play. 5-star rated.',
