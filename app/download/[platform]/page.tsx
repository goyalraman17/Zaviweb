...
> = {
  macos: {
    ...
    metaDescription:
      'Download Zavi AI for macOS. Turn your voice into clean, professional text on your Mac. AI removes filler words, fixes grammar, and works in every app. Free to start.',
    introText:
      'Zavi AI for macOS transforms your Mac into a voice-first workstation. Speak naturally into any app, Gmail, Slack, Notion, Google Docs, or any text field, and get polished, professional text without touching the keyboard. Zavi runs as a lightweight menu bar app with system-wide voice input.',
    detailText:
  ...
  linux: {
    ...
    metaTitle:
      'Download Zavi AI for Linux: Free Voice Typing App for Ubuntu & Debian',
    metaDescription:
      'Download Zavi AI for Linux. AI-powered voice typing for Ubuntu, Debian, and derivatives. Removes filler words, fixes grammar. Free .deb package.',
    introText:
      'Zavi AI for Linux brings professional-grade voice typing to your desktop. Available as a .deb package for Debian-based distributions including Ubuntu, Linux Mint, and Pop!_OS. Speak into any text field across your Linux desktop and get polished, AI-enhanced text.',
    detailText:
  ...
  ios: {
    ...
    metaTitle:
      'Download Zavi AI for iPhone & iPad: Free Voice Action Engine for iOS',
    metaDescription:
      'Download Zavi AI keyboard for iOS. AI voice typing that removes filler words, fixes grammar, and works in every iPhone and iPad app. Free on the App Store.',
    introText:
      'Zavi AI for iOS replaces your iPhone and iPad keyboard with an intelligent voice typing system. Speak naturally in any app, iMessage, WhatsApp, Gmail, Notes, Slack, or any text field, and get clean, professionally written text. No more thumb typing or autocorrect frustrations.',
    detailText:
  ...
  android: {
    ...
    metaDescription:
      'Download Zavi AI for Android. Background agents, 27+ app integrations, voice typing with AI cleanup. Free on Google Play. 5-star rated.',
    introText:
      'Zavi AI for Android is a system-wide keyboard that replaces your default typing experience with intelligent voice input. Speak naturally in any app, Gmail, WhatsApp, Telegram, Slack, Instagram, or any text field, and get polished, error-free text instantly. Rated 5 stars on Google Play.',
    detailText:
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 font-medium max-w-2xl mx-auto">
              Transform your voice into professional text on {data.fullName}.
            ...
            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-2xl shadow-blue-200/50 border border-slate-100">
              ...
              <div className="mt-8 pt-8 border-t border-slate-100 space-y-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-slate-900 font-bold text-green-600">
                    Free to Start
                  </span>
                </div>
              </div>
            ...
            <div className="bg-slate-900 p-8 md:p-10 rounded-[2.5rem] text-white shadow-2xl">
              ...
              <div className="mt-10 p-4 bg-slate-800 rounded-2xl border border-slate-700">
                <p className="text-xs text-slate-400 italic">
                  &quot;Zavi replaces your keyboard with a high-fidelity voice
                  engine that removes &apos;ums&apos;, fixes grammar, and knows
          ...
          <div className="max-w-3xl mx-auto mb-20">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">
              Key Features on {data.name}
            </h3>
            <ul className="space-y-3 text-slate-600 text-lg">
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1 shrink-0">✓</span>
                <span>
                  <strong>AI Voice Typing</strong>, Speak naturally and get
                  clean, professional text with automatic filler word removal
              ...
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1 shrink-0">✓</span>
                <span>
                  <strong>Magic Wand</strong>, Highlight text and transform it
                  by voice: &quot;make this shorter,&quot; &quot;translate to
                  Spanish,&quot; &quot;make this more professional&quot;
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1 shrink-0">✓</span>
                <span>
                  <strong>Voice Agent</strong>, Execute cross-app actions:
                  &quot;email Sarah about the meeting&quot; or &quot;message the
                  team on Slack&quot;
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1 shrink-0">✓</span>
                <span>
                  <strong>100+ Languages</strong>, Speak in one language, type
                  in another with real-time translation and automatic language
                  detection
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-600 mt-1 shrink-0">✓</span>
                <span>
                  <strong>Privacy First</strong>, Voice is processed in
                  real-time and immediately deleted. Never stored, never shared
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="text-center">
            ...
            <Link
              href="/download"
              className="inline-flex items-center gap-2 px-8 py-3 bg-white border border-slate-200 rounded-xl text-slate-700 font-bold hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm"
            >
              View All Platforms
            </Link>
          </div>
