      ...
      <main className="min-h-screen bg-white pt-20 md:pt-28 pb-16 md:pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-20">
            ...
            <p className="text-center text-gray-400 mb-10 font-medium">
              No feature gates on the free plan. Just a daily word limit.
            </p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-100/50">
                    <th className="text-left py-3 px-5 font-semibold text-gray-500 uppercase text-xs tracking-wider">
                      Platform
                    </th>
                    <th className="text-left py-3 px-5 font-semibold text-gray-500 uppercase text-xs tracking-wider">
                      Minimum
