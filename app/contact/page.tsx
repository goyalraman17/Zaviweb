          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-gradient-to-r from-[#6B7FE8] to-[#8B5CF6] rounded-xl flex items-center justify-center mb-4">
                ...
                <a href="mailto:support@zavi.ai" className="text-[#6B7FE8] hover:underline font-semibold">
                  support@zavi.ai
                </a>
              </div>
