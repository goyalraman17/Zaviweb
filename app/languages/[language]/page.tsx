...
export default async function LanguagePage({
  ...
  const proofItems = [
    { label: 'Speakers', value: data.speakers },
    { label: 'Coverage', value: '100+ languages and translation workflows' },
    { label: 'Devices', value: 'iOS, Android, macOS, Windows, Linux' },
  ];
  const comparisonRows = [
    {
      label: 'Typing effort',
      withoutZavi: `Manual ${data.language} typing means wrestling with ${data.scriptInfo.toLowerCase()} and slowing down for every correction.`,
      withZavi: `Speak naturally in ${data.language} and let Zavi handle the script, spacing, punctuation, and cleanup.`,
    },
    {
      label: 'Accuracy',
      withoutZavi:
        'Default keyboards often miss regional accents, code-switching, or specialized wording.',
      withZavi: `Zavi is tuned for ${data.language} use cases, regional pronunciation, and context-driven output.`,
    },
    {
      label: 'Cross-language work',
      withoutZavi:
        'Translation usually means rewriting or copying content into a separate tool.',
      withZavi: `Keep the output in ${data.language} or translate it instantly into English and other supported languages.`,
    },
  ];
      ...
      <main className="min-h-screen bg-white pt-20 md:pt-28 pb-16 md:pb-20">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-16">
          <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 sm:p-8">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              This page is designed to answer whether {data.language} voice
              typing is practical for real work, which accuracy problems matter
              most, and why speaking is often easier than manually typing{' '}
              {data.language} at full speed.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-16">
          <SimpleComparisonTable
            title={`${data.language} typing: default keyboard vs Zavi`}
            rows={comparisonRows}
            withoutLabel="Default keyboard"
            withLabel="With Zavi"
          />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Why {data.language} Voice Typing Is a Game-Changer
          </h2>
          <p className="text-gray-600 mb-8">
            {data.description} Here are the specific challenges Zavi AI solves
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  AI Polishes Your {data.language} Text
                </h3>
                <p className="text-gray-600">
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  Translate or Keep in {data.language}
                </h3>
                <p className="text-gray-600">
                  Get your output in clean {data.language} text, or instantly
                  translate to English or any of 100+ other languages. Perfect
                  for multilingual workflows across {data.regions}.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-16">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-10 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Try {data.language} Voice Typing Free
            </h2>
            <p className="text-blue-100 text-lg mb-8">
              Download Zavi AI and start speaking in {data.language} today. No{' '}
              {data.language} keyboard needed.
            </p>
            <Link
              href="/#download"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Voice Typing in Other Languages
          </h2>
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/languages"
              className="px-4 py-2 border border-blue-200 rounded-full text-sm text-blue-600 font-medium hover:bg-blue-50 transition-all"
            >
              View all 100+ →
            </Link>
          </div>
