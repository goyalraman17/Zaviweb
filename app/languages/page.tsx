...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{ url: 'https://zavivoice.com/og-image.png', width: 1200, height: 630, alt: 'Zavi AI — Voice Typing in 100+ Languages' }],
    },
};
...
export default function LanguagesPage() {
    ...
    const itemListSchema = generateItemListSchema(
        languages.map((lang) => ({
            name: `${lang.language} Voice Typing`,
            url: `https://zavivoice.com/languages/${lang.slug}`,
